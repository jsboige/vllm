...
**Date de Génération** : 2025-10-21 20:00:50
**Nombre de Configurations Testées** : 4
...
- **prefix_only_safe** : not_executed
  - Erreurs : Health check échoué : Container a terminé avec l'état: exited
- **chunked_only_safe** : not_executed
  - Erreurs : Health check échoué : Container a terminé avec l'état: exited
