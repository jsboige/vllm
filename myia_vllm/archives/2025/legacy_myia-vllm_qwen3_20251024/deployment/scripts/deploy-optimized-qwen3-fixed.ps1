...
$tempEnvFile = "myia-vllm/qwen3/deployment/docker/.env.temp"
@"
...
docker-compose --env-file $tempEnvFile -f myia-vllm/qwen3/deployment/docker/docker-compose-medium-qwen3-optimized.yml up -d
...
docker-compose --env-file $tempEnvFile -f myia-vllm/qwen3/deployment/docker/docker-compose-mini-qwen3-optimized.yml up -d
...
docker-compose --env-file $tempEnvFile -f myia-vllm/qwen3/deployment/docker/docker-compose-micro-qwen3-optimized.yml up -d
