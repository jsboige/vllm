#!/usr/bin/env python3
"""
Test script for verifying tool calling functionality with Qwen3 models.
...
def test_tool_calling(model_type="micro"):
    ...
    payload = {
        ...
        "messages": [
            ...
            {"role": "user", "content": "What's the weather like in Paris? Use the get_weather tool."}
        ],
        "tools": [
            {
                "type": "function",
