...
## Current State (2026-09-11: **prod on stock `vllm/vllm-openai:v0.29.0` + TurboQuant k8v4 — Model Runner V2 under WSL2 via `VLLM_WSL2_ENABLE_PIN_MEMORY=1`, prefix cache granularity 16 + fp16 mamba state** — v0.29.0 promoted 09-11, 13/13 gates, N=16 **869.5 vs 766.1** same-evening (+13.5%), PR #39 merged `7c9730188d`; windows A+B same day, PR #37; bumped from v0.27.1 on 09-01; container serving the NEW HF token since 08-31; gpu-util 0.70, KV 934,660, batch 8192)
