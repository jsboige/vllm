...
## Current State (2026-09-11: **prod on stock `vllm/vllm-openai:v0.28.0` + TurboQuant k8v4, prefix cache granularity 16 + fp16 mamba state** — window A+B of 09-11 21:16Z, 13/13 gates, PR #37 merged `2ca0a1ea52`; bumped from v0.27.1 on 09-01, A/B N=16 828 vs 813; container serving the NEW HF token since 08-31; gpu-util 0.70, KV 944,267, batch 8192)
